...
export function Genres(props: DropdownProps) {
  ...
  return (
    <div className={`w-52 relative mx-6 mt-2 ${props.className}`}>
      <button
        ...
        <div className="absolute z-10 w-full mt-2 bg-white rounded-lg shadow-lg dark:bg-gray-700">
          ...
          <ul className="h-48 px-3 pb-3 overflow-y-auto text-sm text-gray-700 dark:text-gray-200">
            {filteredGenres.map((genre) => (
              <li key={genre.id} className="flex items-center ps-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                <input
                ...
                />
                <label htmlFor={`checkbox-item-${genre.id}`} className="w-full py-2 ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">
                  {genre.name}
                </label>
              </li>
            ))}
